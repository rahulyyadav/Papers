...
export default function PDFViewer({
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen relative">
      ...
      <div className="md:hidden flex flex-col flex-1 bg-white p-6 overflow-y-auto">
        ...
        <div className="mt-auto flex items-center space-x-2">
          ...
          <button
            ...
            className="bg-blue-600 text-white w-10 h-10 rounded-full hover:bg-blue-700 transition flex items-center justify-center"
      ...
      <div className="hidden md:flex w-2/5 h-full bg-white p-6 flex-col rounded-2xl shadow-lg transition duration-300 hover:shadow-xl">
