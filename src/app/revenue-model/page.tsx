      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="mb-2 leading-relaxed">
            ...
            <strong>1% of the total advertising revenue</strong> generated from
            <em>all</em> papers uploaded under that university, for a lifetime.
          </p>
        </div>
        ...
        <p className="mb-6 leading-relaxed">
          ...
          you&apos;ve added. Official earnings reports will be sent monthly via
          email.
        </p>
        ...
        <p className="mb-2 leading-relaxed">
          As the platform grows, we plan to introduce additional revenue streams
          and features to further reward contributors, such as:
        </p>
